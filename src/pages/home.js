...
import image from "../images/afe.jpg";
        ...
        <Grid container>
          <Grid item xs={12}>
            <div className='homebar'>
              <div className='homediv' onClick={this.refresh}>
                Home
              </div>
            ...
            <div className={classes.intro}>
              ...
              <div className={classes.tweetDiv}>
                <svg viewBox='0 0 24 24' className='tweetButtons'>
                  <g>
                ...
                <Button
                  variant='contained'
                  className='tweetButtons' style={{marginLeft:20, marginBottom:20}}
          ...
          <Grid item xs={false} md={4} sm={false} lg={4} className={classes.home}>
            <Searchbar />
          </Grid>
        </Grid>
      </Fragment>
